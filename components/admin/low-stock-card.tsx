...
import type { LowStockProductRow } from "@/lib/queries/admin-inventory";
  ...
  return (
    <div className={cn("rounded-lg border border-border", className)}>
      <div className="flex items-center justify-between gap-3 p-6 pb-4">
        <h2 className="text-sm font-medium">محصولات با موجودی رو به اتمام</h2>
        {products.length > 0 && (
      ...
      {products.length === 0 ? (
        <p className="px-6 pb-6 text-sm text-muted-foreground">
          در حال حاضر هیچ محصولی موجودی کم ندارد.
        </p>
      ) : (
        <>
          <Table>
